...
public class AutoTest extends basic {
    ...
    private final Pose readyHang3Pose = new Pose(17, 69, Math.toRadians(180));
    private final Pose hang3Pose = new Pose(40.8, 69, Math.toRadians(180));
    private final Pose get3Pose = new Pose(17, 26, Math.toRadians(180));
    private final Pose readyHang4Pose = new Pose(17, 70, Math.toRadians(180));
    ...
    private final Pose readyHang5Pose = new Pose(17, 71, Math.toRadians(180));
    private final Pose hang5Pose = new Pose(40.8, 71, Math.toRadians(180));
    private final Pose endPose = new Pose(15, 15, Math.toRadians(180));
